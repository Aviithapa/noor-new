                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                       @if(isset($model))
                                             <form method="post" action="{{ route('testimonial.update', ["testimonial" => $model->id]) }}" enctype="multipart/form-data">
                                                 @method('PUT')
                                        @else
                                        ...
                                        <div class="row"> 
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="validationCustom01" placeholder="Type" name="type" value="Testimonial Management" disabled>
                                                     @if($errors->any())
                                                         {{ $errors->first('email') }}
                                                      @endif
                                                </div>
