  ...
  <!-- start page title -->
                        ...
                        <!-- end page title -->
                         ...
                         <div class="card">
                                    ...
                                    <form action="{{  route("testimonial.index") }}"  method="GET" novalidate>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            <div class="card-widgets">
                                                <a href="{{ route('testimonial.create') }}" class="btn btn-primary" style="color: white;">Create New Testimonial</a>
                                            </div>
                                            <h5 class="header-title mb-0">Testimonial List</h5>
                                        </div>
                                        ...
                                        <div id="yearly-sales-collapse" class="collapse show">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-nowrap table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $data->slug }}</td>
                                                            <td>{{ $data->excerpt }}</td>
                                                            <td><a href="{{ route('testimonial.edit', ['testimonial' => $data->id]) }}"><span class="badge bg-info-subtle text-info">Edit</span></a>
                                                ...
                                                {{  $testimonial->appends(request()->query())->links('admin.layout.pagination') }}
                                                </div>
                                            </div>        
                                        </div>
                                    </div>                           
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                         <form  action="#" method="testimonial" id="deleteForm">
                                                                  @csrf
                                                                @method('DELETE')
