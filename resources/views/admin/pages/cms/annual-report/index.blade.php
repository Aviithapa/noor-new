  ...
  <!-- start page title -->
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Noor</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Annual Report</a></li>
                        ...
                        <!-- end page title -->
                         ...
                         <div class="card">
                                    ...
                                    <form action="{{  route("annual-report.index") }}"  method="GET" novalidate>
                                    ...
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            <div class="card-widgets">
                                                <a href="{{ route('annual-report.create') }}" class="btn btn-primary" style="color: white;">Create New Annual Report</a>
                                            </div>
                                            <h5 class="header-title mb-0">Annual Report List</h5>
                                            {{-- <h1>{{ trans('message.create_success') }}</h1> --}}
                                        </div>
                                                ...
                                                <table class="table table-nowrap table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $data->title }}</td>
                                                            <td>{{ $data->slug }}</td>
                                                            <td><a href="{{ route('annual-report.edit', ['annual_report' => $data->id]) }}"><span class="badge bg-info-subtle text-info">Edit</span></a>
                                                               <a  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat"  data-attr="{{ route('annual-report.destroy', ['annual_report' => $data->id]) }}" style="cursor: pointer;"><span class="badge bg-danger-subtle text-danger">Delete</span></a>                                                            </td>
