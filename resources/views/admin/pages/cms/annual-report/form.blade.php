                    ...
                    <div class="row mt-5">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                       @if(isset($model))
                                             <form method="POST" action="{{ route('annual-report.update', ["annual_report" => $model->id]) }}" enctype="multipart/form-data">
                                                 @method('PUT')
                                        @else
                                            <form method="POST" action="{{ route('annual-report.store') }}" enctype="multipart/form-data">
                                        @endif
                                        @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group mb-3">
                                                <label class="form-label" for="inputFile">Annual Report:</label>
                                                <input type="file" name="file" id="inputFile" multiple accept=".pdf"
