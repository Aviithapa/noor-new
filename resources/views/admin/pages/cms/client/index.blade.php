                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="client-title-box">
                                    <div class="client-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Noor</a></li>
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">Client / Partner</a></li>

                                        </ol>
                                    </div>
                                    <h4 class="client-title">Welcome!</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end client title -->
                                    ...
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            <div class="card-widgets">
                                                <a href="{{ route('client.create') }}" class="btn btn-primary" style="color: white;">Create New Client</a>
                                            </div>
                                            <h5 class="header-title mb-0">Client / Partner List</h5>
                                        </div>
                                        ...
                                        <div id="yearly-sales-collapse" class="collapse show">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-nowrap table-hover mb-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $data->slug }}</td>
                                                            <td>{{ $data->excerpt }}</td>
                                                            <td><a href="{{ route('client.edit', ['client' => $data->id]) }}"><span class="badge bg-info-subtle text-info">Edit</span></a>
                                                               <a  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat"  data-attr="{{ route('client.destroy', ['client' => $data->id]) }}" style="cursor: pointer;"><span class="badge bg-danger-subtle text-danger">Delete</span></a>                                                            </td>
                                                ...
                                                {{  $clients->appends(request()->query())->links('admin.layout.pagination') }}
                                                </div>
                                            </div>        
                                        </div>
                                    </div>                           
