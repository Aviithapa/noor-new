    ...
    <div class="row mt-5">
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    @if (isset($model))
                        <form method="POST" action="{{ route('page.update', ['page' => $model->id]) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder="Type"
                                    name="type" value="Page Management" disabled>
                                @if ($errors->any())
                                    {{ $errors->first('email') }}
                                @endif
                            </div>
                        ...
                        <div class="form-group mb-3">
                            <label class="form-label" for="inputFile">Cover Photo Page:</label>
                            <input type="file" name="file" id="inputFile"
                                class="form-control @error('file') is-invalid @enderror">
                        </div>
                        @if (isset($model->image))
                            <div class="col-lg-3 col-md-3 col-sm-6" style="position: relative;">
                                <img src="{{ getImage($model->image) }}" style="height: 200px;" alt={{ $model->title }} />
