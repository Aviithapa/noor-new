                                    ...
                                    <div class="card-body p-0">
                                        <div class="p-3">
                                            <div class="card-widgets">
                                                <a href="{{ route('page.create') }}" class="btn btn-primary" style="color: white;">Create New Page</a>
                                            </div>
                                            <h5 class="header-title mb-0">Pages List</h5>
                                        </div>
                                        ...
                                        <div id="yearly-sales-collapse" class="collapse show">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                {{  $pages->appends(request()->query())->links('admin.layout.pagination') }}
                                                </div>
                                            </div>        
                                        </div>
                                    </div>                           
