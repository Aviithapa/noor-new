...
class ProvinceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        try {
            ...
            foreach ($dataArray as $provinceData) {
                $province = Province::create([
                    'name' => $provinceData['name'],
                ]);

                foreach ($provinceData['districtList'] as $districtData) {
                    $district = $province->districts()->create([
                        'name' => $districtData['name'],
                    ]);

                    foreach ($districtData['municipalityList'] as $municipalityData) {
                        $district->municipalities()->create([
            ...
            throw $e; // Optionally, log or handle the error as needed
        }
    }
}
