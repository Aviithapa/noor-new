...
class ClientController extends Controller
{
    ...
    {
        //
        $clients = $this->postRepository->getPaginatedList($request, 'clients');
        return view('admin.pages.cms.client.index', compact('clients', 'request'));
    }
    ...
    {
        //
        return view('admin.pages.cms.client.create');
    }
        ...
        try {
            ...
            if ($news == false) {
                ...
                foreach ($data['files'] as $file) {
                    $response =  $this->fileUploader->upload($file, "client");
    ...
    {
        //
        $client = $this->postRepository->findOrFail($id);
        return view('admin.pages.cms.client.edit', compact('client'));
    }
    ...
    {
        try {
            $client = $this->postRepository->delete($id);
            if ($client == false) {
                session()->flash('danger', 'Oops! Something went wrong.');
                return redirect()->back()->withInput();
            }
